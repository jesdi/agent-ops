...
it('renders one pip per capacity unit, filled up to active', () => {
  render(<CapacityMeter capacity={{ active: 1, capacity: 3, slots_used: 1, max_slots: 3, slots_held: [] }} />)
...
it('fills every pip at full capacity', () => {
  render(<CapacityMeter capacity={{ active: 3, capacity: 3, slots_used: 3, max_slots: 3, slots_held: [] }} />)
...
it('keeps the text truthful when active overshoots a lowered capacity', () => {
  render(<CapacityMeter capacity={{ active: 3, capacity: 2, slots_used: 2, max_slots: 3, slots_held: [] }} />)
...
it('AWKWARD: falls back to text only when capacity is misconfigured to zero', () => {
  render(<CapacityMeter capacity={{ active: 0, capacity: 0, slots_used: 0, max_slots: 3, slots_held: [] }} />)
...
it('still reports slots as plain text', () => {
  render(<CapacityMeter capacity={{ active: 2, capacity: 3, slots_used: 2, max_slots: 3, slots_held: [] }} />)
